  ...
  head: () => ({
    meta: [
      ...
      { title: "ChatSphere — realtime messaging that feels instant" },
      {
        name: "description",
        content:
          "ChatSphere is a premium realtime chat workspace with presence, typing indicators, read receipts and a glassy interface.",
      },
      { name: "author", content: "ChatSphere" },
      { property: "og:title", content: "ChatSphere — realtime messaging that feels instant" },
      {
        property: "og:description",
        content: "A premium realtime chat workspace with presence, typing indicators and read receipts.",
      },
